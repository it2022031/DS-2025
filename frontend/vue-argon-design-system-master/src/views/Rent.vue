...
<!--      &lt;!&ndash; Φόρμα δημιουργίας ενοικίασης &ndash;&gt;-->
...
<!--      &lt;!&ndash; Λίστα Ενοικιάσεων μόνο για admin &ndash;&gt;-->
<!--      <div v-if="isAdmin">-->
...
<!--      &lt;!&ndash; Λίστα Ενοικιάσεων του τρέχοντος χρήστη &ndash;&gt;-->
<!--      <div v-else>-->
...
<!--      &lt;!&ndash; Modal Επεξεργασίας &ndash;&gt;-->
